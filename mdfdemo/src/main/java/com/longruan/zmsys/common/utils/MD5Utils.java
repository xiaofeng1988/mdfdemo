package com.longruan.zmsys.common.utils;
...
public class MD5Utils {
  ...
  public static String getSimenMD5(String strSrc) {
    ...
    str2.append(str1.substring(0, 2)).append("|").append(str1.substring(4, 10)).append("|").append(str1.substring(8, 21)).append("|").append(str1.substring(14, 19)).append("|").append(str1.substring(1, 9)).append("|").append(str1.substring(24, 27));
...
//    // String md5 = getFileMD5String(new File("E://ccc.rar"));
//    // long end = System.currentTimeMillis();
//    // System.out.println("MD5:\t" + md5 + "\nTime:\t" + (end - begin) + "ms");
//    // midstr(str , 0 ,2) + midstr(str , 5 ,6) + midstr(str , 9 ,13) +
//    // midstr(str , 15 ,26) + midstr(str , 2 ,8) + midstr(str , 25 ,32);
////    System.out.println(MD5Utils.getMD5String("lisi"));
//  }
}
