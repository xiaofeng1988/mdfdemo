...
import com.longruan.zmsys.common.online.OnlineManager;
import com.longruan.zmsys.common.utils.CheckMobile;
import com.longruan.zmsys.common.utils.CommonUtil;
import com.longruan.zmsys.common.utils.CommonValue;
import com.longruan.zmsys.common.utils.DateUtil;
import com.longruan.zmsys.common.utils.SessionUtil;
import com.longruan.zmsys.models.SysUser;
import com.longruan.zmsys.models.SysUserOnline;
import com.longruan.zmsys.modules.sys.service.ISysRightService;
import com.longruan.zmsys.modules.sys.service.ISysUserService;
...
public class LoginInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (httpUrl.contains("/mdf/")) {
			httpUrl = httpUrl.replace("/mdf/", ""); // 截取请求路径API=配置API
		}
		...
		if (sysUser != null) {
			...
			if (currentUserRightUrlMap.containsKey(httpUrl)) {
				...
				out.println("<html>");
				out.println("<script>");
				out.println("alert('Session失效，请重新登陆...');window.parent.location.href='/mdf/sysUserController/loginOut'");
				out.println("</script>");
				out.println("</html>");
				out.close();
				return false;			
