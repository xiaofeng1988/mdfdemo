...
<body>
<img src="${pageContext.request.contextPath }/view/desk/images/safe.jpg" alt="" id="background" />
	<div class="prorequ">
            ...
            <a hidefocus="true" class="link safelink2" href="javascript:indexLoad('08')"></a>
            <a hidefocus="true" class="link safelink5" href="javascript:indexLoad('03')"></a>
            <a hidefocus="true" class="link safelink6" href="javascript:indexLoad('07')"></a>
       		 </div>
        </div>
<script type="text/javascript">
