			...
			// 定义数据表
			 var iCount=getAutoRowCount();  
		 	 $("#tabId").datagrid({ 
				    ...
				    url:'${rootPath}/reqUrlCtr/findReqUrlPageByConditions',  
				    columns:[[   
				        {field:'ck',checkbox:true},  
				        {field:'id',hidden:true},     
				        {field:'req_title',title:'API说明',width:$(this).width() * 0.2}, 
				        {field:'req_url',title:'API地址',width:$(this).width() * 0.3}, 
				        {field:'req_type',title:'API类型',width:$(this).width() * 0.1}, 
