			...
			$(function(){
				...
				$("#alltreeId").tree({
					...
					onClick:function(node){
						$.post('${rootPath}/apiSysModuleCtr/'+node.id+'/detailSysModule', null, function(data){
							$("#detailId").html(data);
				...
				$("#addId").click(function(){
					...
					$("#adddeptpanel901").dialog("refresh", '${rootPath}/apiSysModuleCtr/'+nodeid+'/add/load');
				...
				$("#deleteId").click(function(){
					...
					if(node){
						$.messager.confirm("警告", "你确定要删除当前数据吗?" , function(r){
							if(r){
								$.post("${rootPath}/apiSysModuleCtr/"+node.id+"/apiSysModule/delete/", null, function(data){
				...
				$("#editId").click(function(){
					...
					if(node){
						...
						$("#adddeptpanel901").dialog("refresh", '${rootPath}/apiSysModuleCtr/apiSysModule/'+node.id+'/edit');
						$("#adddeptpanel901").dialog({
							title:'修改功能信息',
