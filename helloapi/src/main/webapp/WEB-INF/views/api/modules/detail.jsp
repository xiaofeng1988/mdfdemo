	...
	<head>
		<script type="text/javascript">
			...
			function moveUp(){
				...
				$.post("${rootPath}/apiSysModuleCtr/apiSysModule/moveUpApiSysModule", 
			...
			function moveDown(){
				...
				// 向后台发送请求，当前节点值（newNode.id），当前角标值（newNode.orderId - 1）
				$.post("${rootPath}/apiSysModuleCtr/apiSysModule/moveDownApiSysModule", 
    ...
    <table class="defaulttableStyle" cellspacing="1px">
             <tr style="height: 35px">
                 <th colspan="2" style="text-align: left">
                     ...
                     <input type="hidden" id="hiddenNodeId" value="${apiSysModule.id }"></input>
                 </th>
             </tr>
<%--             <tr style="height: 35px">--%>
...
<%--                 </td>--%>
<%--                 <td>--%>
<%--                     <div id="deptnum901">${apiSysModule.nodeid }</div>--%>
<%--                 </td>--%>
<%--             </tr>--%>
             <tr style="height: 35px">
                 <td>模块名称</td>
                 <td>
                     <div id="deptname901">${apiSysModule.name }</div>
                 </td>
             </tr>
             <tr style="height: 35px">
                 <td>模块备注</td>
                 <td>
                     <div id="depttype901">${apiSysModule.des }</div>
                 </td>
             </tr>
             <tr style="height: 35px">
                 <td>修改排序</td>
